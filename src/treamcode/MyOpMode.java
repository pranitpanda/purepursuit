...
public class MyOpMode extends OpMode {
    public static double[] followAngles = {Math.toRadians(90),Math.toRadians(90),Math.toRadians(90), Math.toRadians(-90), Math.toRadians(-90),
            ...
            Math.toRadians(90), Math.toRadians(-90), Math.toRadians(-90), Math.toRadians(90)};
    public void init(){
    ...
    public void loop(){
        ...
        allPoints.add(new CurvePoint(50 , 180,0.4 ,0.5 ,35, Math.toRadians(30), 0.5));
        ...
        allPoints.add(new CurvePoint(90, 260,0.3,0.9,25, Math.toRadians(15),0.1));
        allPoints.add(new CurvePoint(120, 260, 0.3, 0.5, 25, Math.toRadians(20), 0.1));
        allPoints.add(new CurvePoint(90, 260,0.3,0.5,25, Math.toRadians(15),0.5));
        allPoints.add(new CurvePoint(70, 250,0.3 ,0.5 ,25, Math.toRadians(20), 0.5));
        allPoints.add(new CurvePoint(50 , 230,0.3 ,0.5 ,35, Math.toRadians(30), 0.2));
        allPoints.add(new CurvePoint(50 , 100,0.8 ,0.5 ,35, Math.toRadians(30), 0.2));
        allPoints.add(new CurvePoint(150 , 50,0.3 ,0.5 ,25, Math.toRadians(30), 0.2));
        allPoints.add(new CurvePoint(80 , 150,0.3 ,0.5 ,35, Math.toRadians(30), 0.2));
        allPoints.add(new CurvePoint(80 , 300,0.3 ,0.5 ,35, Math.toRadians(30), 0.2));
        allPoints.add(new CurvePoint(80 , 150,0.8 ,0.5 ,35, Math.toRadians(30), 0.2));
